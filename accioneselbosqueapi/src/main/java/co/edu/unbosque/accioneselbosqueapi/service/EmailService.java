/**
 * Paquete que contiene los servicios generales de la aplicación Acciones El Bosque.
 * Aquí se define la lógica de negocio reutilizable como el envío de correos electrónicos.
 */
...
public class EmailService {
    ...
    // Inyección del componente JavaMailSender configurado en MailConfig
    @Autowired
